...
puis pour détacher le bind:

	umount /var/lib/motioneye/

A noter: lorsqu'on détache le bind, l'arborescence reste intacte, on peut ensuite supprimer l'arborescence si on le souhaite.
